      ...
      <AnimatePresence>
        {toasts.map(toast => (
          <motion.div
            ...
            className="pointer-events-auto bg-[#121212] text-white p-4 rounded-xl shadow-2xl border border-[#27272A] flex items-start gap-3.5 backdrop-blur-md"
          >
            {toast.type === 'success' && (
            ...
            <div className="flex-1 min-w-0">
              ...
              {toast.message && (
                <p className="text-xs text-zinc-300 mt-0.5 font-normal leading-relaxed truncate">
                  {toast.message}
                </p>
              )}
            </div>
